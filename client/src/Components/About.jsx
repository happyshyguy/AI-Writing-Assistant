    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4">About AI Writing Assistant</h1>
        ...
        <section className="bg-slate-800 border border-slate-700 rounded-lg p-8 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-gray-300 space-y-1 ml-8">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <FiServer className="text-2xl text-green-400" />
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <FiDatabase className="text-2xl text-cyan-400" />
        ...
        {/* Architecture */}
        <section className="bg-slate-800 border border-slate-700 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold mb-4 text-orange-400">Architecture</h2>
          <p className="text-gray-300 mb-4 leading-relaxed">
            The application follows a clean client-server architecture:
          </p>
          <div className="bg-slate-700 p-4 rounded-lg text-gray-300 space-y-2 font-mono text-sm">
            <p><span className="text-blue-400">Client (React)</span> → User enters text</p>
            <p className="text-center text-gray-500">↓</p>
            <p><span className="text-green-400">HTTP Request</span> → Sent to Express Server</p>
            <p className="text-center text-gray-500">↓</p>
            <p><span className="text-yellow-400">Server (Express)</span> → Validates & forwards to GROQ</p>
            <p className="text-center text-gray-500">↓</p>
            <p><span className="text-purple-400">GROQ LLM API</span> → Processes with Llama model</p>
            <p className="text-center text-gray-500">↓</p>
            <p><span className="text-cyan-400">Response Flow</span> → Back to Client & Display</p>
          </div>
        </section>

        {/* Use Cases */}
        <section className="bg-slate-800 border border-slate-700 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-pink-400">Perfect For</h2>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-slate-700 p-4 rounded-lg">
              <h3 className="font-bold text-blue-400 mb-2">👨‍🎓 Students</h3>
              <p className="text-gray-300 text-sm">Polish essays, assignments, and research papers for better grades.</p>
            </div>
            <div className="bg-slate-700 p-4 rounded-lg">
              <h3 className="font-bold text-cyan-400 mb-2">✍️ Content Creators</h3>
              <p className="text-gray-300 text-sm">Ensure blogs, articles, and social media content are error-free.</p>
            </div>
            <div className="bg-slate-700 p-4 rounded-lg">
              <h3 className="font-bold text-green-400 mb-2">🌍 Non-Native Speakers</h3>
              <p className="text-gray-300 text-sm">Learn natural phrasing and improve English writing skills.</p>
            </div>
            <div className="bg-slate-700 p-4 rounded-lg">
              <h3 className="font-bold text-purple-400 mb-2">💼 Professionals</h3>
              <p className="text-gray-300 text-sm">Create polished emails, reports, and professional communications.</p>
            </div>
          </div>
        </section>
        ...
        {/* Author Info */}
        <section className="bg-slate-800 border border-slate-700 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold mb-4 text-indigo-400">About the Creator</h2>
          <div className="flex items-start gap-4">
            <div>
              <p className="text-gray-300 mb-2">
                <strong>Project:</strong> AI Writing Assistant
              </p>
              <p className="text-gray-300 mb-2">
                <strong>Creator:</strong> Aryan Gupta
              </p>
              <p className="text-gray-300 mb-4">
                <strong>Status:</strong> Version 1.0 - Complete & Functional
              </p>
              <p className="text-gray-300 leading-relaxed">
        ...
        {/* Future Roadmap */}
        <section className="bg-slate-800 border border-slate-700 rounded-lg p-8 mb-8">
          <h2 className="text-3xl font-bold mb-6 text-green-400">Future Improvements</h2>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <span className="text-green-400 mt-1">→</span>
              <p className="text-gray-300">Comprehensive unit and integration tests</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-blue-400 mt-1">→</span>
              <p className="text-gray-300">Advanced editor panel with diff view and multiple sentences</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-purple-400 mt-1">→</span>
              <p className="text-gray-300">User authentication and personalized usage tracking</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-cyan-400 mt-1">→</span>
              <p className="text-gray-300">API caching and rate limiting for optimized performance</p>
            </div>
            <div className="flex items-start gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-300">Browser extensions for in-page text correction</p>
            </div>
          </div>
        </section>
